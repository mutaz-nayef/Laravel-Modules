...
use Modules\Authorization\Infrastructure\Services\LaravelReverb;
...
use Modules\Shared\Domain\Contracts\RealtimePublisher;
...

{
    public function boot(): void
    {
        ...
        require base_path(
            'Modules/Authorization/Infrastructure/Routes/channels.php'
        );
